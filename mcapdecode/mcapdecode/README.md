...
```toml
[dependencies]
mcapdecode = { version = "0.5.0", default-features = false, features = ["protobuf"] }
```
...
```toml
[dependencies]
mcapdecode = { version = "0.5.0", default-features = false, features = ["arrow", "protobuf"] }
```
...
```toml
[dependencies]
mcapdecode = { version = "0.5.0", features = ["arrow"] }
```
